...
author: 小皮咖
location: 广州
summary: "E 大的网格策略我认真研究了一遍，越跌越买、留存利润的思路确实巧妙。我还在文章里做了一个交互式的网格计算器，输入参数自动生成操作计划表。做波段的朋友可以拿去用。"
---
...
<div style="position: fixed; width: 1200px;top: 0px; left: 0;z-index: -2;background: #fff;" class="download-wrapper">

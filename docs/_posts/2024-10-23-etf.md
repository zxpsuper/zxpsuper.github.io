...
<div style="position: fixed; width: 1200px;top: 0; left: 0;z-index: -1;background: #fff;" class="download-wrapper">
    ...
    export default {
        ...
        methods: {
            downloadImage() {
                ...
                const table = document.querySelector('.download-wrapper')
                toPng(table).then(res => {
                    downloadBase64Image(res, this.form.inputName + '操作示意表')
                    instance.close()
